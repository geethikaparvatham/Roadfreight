...
export function DriverSettings() {
  ...
  const [email, setEmail] = useState(user?.email || "driver@logistics.com");
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <select 
                  value={role}
                  disabled
                  className="w-full flex h-10 w-full items-center justify-between rounded-md border border-zinc-200 bg-zinc-50 px-3 py-2 pl-9 text-sm text-zinc-500 dark:border-zinc-800 dark:bg-zinc-900/50"
                >
